...
<section class="content">
    <div class="container-fluid">
        <div class="text-right mb-3">
            <a href="{{ route('admin.equipment.create') }}" class="btn bg-gradient-primary px-5">Novo equipamento</a>
        </div>
                    ...
                    <tbody>
                        @foreach ($equipments as $equipment)
                            <tr>
                                ...
                                <td>
                                    {{-- <a href="{{ route('admin.equipment.show', $equipment->cd_eqpt) }}" class="btn btn-success btn-sm" data-toggle="tooltip" title="Visualizar equipamento">
                                        <i class="fas fa-eye"></i>
                                    </a> --}}
                                    <a href="{{ route('admin.equipment.edit', $equipment->cd_eqpt) }}" class="btn btn-info btn-sm" data-toggle="tooltip" title="Editar equipamento">
                                    ...
                                    <form method="post" action="{{ route('api.equipment.destroy', $equipment->cd_eqpt) }}" id="delete_{{ $equipment->cd_eqpt }}" class="form-delete-equipment">
                                        {{ csrf_field() }}
                                        {{ method_field('DELETE') }}
                                    </form>
                                </td>
