...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Equipamentos diferentes de jato com capacidade até 100 passageiros</h1>
            </div>
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Equipamentos diferentes de jato com capacidade até 100 passageiros</li>
                </ol>
            </div>
        </div>
    </div>
    ...
    <script>
        $(document).ready(function () {
            const ps_datatable = new PSDataTable({
                title: '{{ config("app.name") }} - Equipamentos diferentes de jato com capacidade até 100 passageiros',
                columns: [0, 1, 2],
