...
<div class="content-header">
    <div class="container-fluid">
        <div class="row mb-2">
            <div class="col-sm-6">
                <h1 class="m-0">Capacidade de transporte</h1>
            </div>
            ...
            <div class="col-sm-6">
                <ol class="breadcrumb float-sm-right">
                    ...
                    <li class="breadcrumb-item active">Capacidade de transporte</li>
                </ol>
            </div>
        </div>
    </div>
...
<section class="content">
    ...
    <div class="container-fluid">
        <div class="card card-second card-outline">
            <div class="card-body">
                <h5>Filtrar por:</h5>
                <form action="{{ route('admin.report.carrying_capacity') }}" method="GET" class="mb-4">
                    <div class="form-row">
    ...
    <script>
        $(document).ready(function () {
            const ps_datatable = new PSDataTable({
                title: '{{ config("app.name") }} - Capacidade de transporte',
                columns: [0, 1],
